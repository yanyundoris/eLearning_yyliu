...
root_dir = '/disk02/data/eLearning/raw_teaching_material/Android_audio_channel/split/'
# List all the file and subdirectory name
path_factor = os.listdir('/disk02/data/eLearning/AudioAnalysis/newchannel')



with open("/disk02/data/eLearning/AudioAnalysis/newchannel/result_android.txt", "w+") as f:
